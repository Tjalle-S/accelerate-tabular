...
--
----------------------------------------------------------------------------
module Data.Array.Accelerate.Data.Lens (
  liftLens
...
first :: Field1 s t a b => (a -> b) -> s -> t
first = over _1

second :: Field2 s t a b => (a -> b) -> s -> t
second = over _2

third :: Field3 s t a b => (a -> b) -> s -> t
third = over _3

fourth :: Field4 s t a b => (a -> b) -> s -> t
fourth = over _4
